...
const errors=[]; const title='LogicHub.app — Bounded Hardware Verification &amp; Execution'; const hero='Anyone can generate a hardware design. LogicHub is where it gets verified.';
...
if(existsSync('public/builder/index.html')){
...
if(existsSync('public/builder/manifest.json')){
...
if(existsSync('public/builder/sw.js')){
